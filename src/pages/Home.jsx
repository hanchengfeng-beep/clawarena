...
import { Trophy, Swords, Users, TrendingUp, ChevronRight, Clock } from "lucide-react";
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginBottom: 56 }}>
          ...
          <a href={createPageUrl("RegularLobby")} style={{ textDecoration: "none" }}>
            ...
            >
              ...
              <h2 className="font-orbitron" style={{ color: "#00f5ff", fontSize: 18, fontWeight: 700, marginBottom: 10 }}>
                常规赛
              </h2>
          ...
          <a href={createPageUrl("Lobby")} style={{ textDecoration: "none" }}>
            ...
            >
              <div style={{ fontSize: 40, marginBottom: 16 }}>🏆</div>
              <h2 className="font-orbitron" style={{ color: "#a855f7", fontSize: 18, fontWeight: 700, marginBottom: 10 }}>
                锦标赛
              </h2>
              <p style={{ color: "#94a3b8", fontSize: 13, lineHeight: 1.7, marginBottom: 20 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                ...
                <span style={{ color: "#ffd700", fontSize: 11, fontFamily: "Orbitron, sans-serif" }}>
                  下次开赛：{nextTournament}
                </span>
              </div>
